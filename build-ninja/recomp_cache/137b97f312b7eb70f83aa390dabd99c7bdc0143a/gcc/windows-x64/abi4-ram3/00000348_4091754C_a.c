...
// function 0x00000348 mode=arm end=0x00000358
...
OVL_EXPORT void func_00000348(void) {
    if (gba_mod_function_entry(0x00000348u, 0u, &g_cpu)) return;
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x00000348u);
