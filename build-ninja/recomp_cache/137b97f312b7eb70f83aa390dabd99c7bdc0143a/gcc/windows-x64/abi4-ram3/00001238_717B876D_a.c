...
// function 0x00001238 mode=arm end=0x00001260
...
OVL_EXPORT void func_00001238(void) {
    if (gba_mod_function_entry(0x00001238u, 0u, &g_cpu)) return;
    if (g_runtime_fn_entry_hook) g_runtime_fn_entry_hook(0x00001238u);
    /* 00001238  00001238 A ldrh r9,[r1,-r8] */
    g_cpu.R[15] = 0x00001238u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_00001238 = 1u;
    _cyc_00001238 = 2u;
    uint32_t _base_00001238 = g_cpu.R[1];
    uint32_t _off_00001238;
    uint32_t _morm_00001238 = g_cpu.R[8];
    _off_00001238 = _morm_00001238;
    uint32_t _ea_00001238 = _base_00001238 - _off_00001238;
    uint32_t _post_00001238 = _base_00001238 - _off_00001238;
    _cyc_00001238 += runtime_mem_cycles(_ea_00001238, 2u, 0u);
    uint32_t _v_00001238;
    { uint32_t _h = bus_read_u16(_ea_00001238 & ~1u); if (_ea_00001238 & 1u) _v_00001238 = ((_h >> 8) | (_h << 24)); else _v_00001238 = _h; }
    g_cpu.R[9] = _v_00001238;
    g_cpu.R[15] = 0x0000123Cu;
    runtime_tick(_cyc_00001238);
    /* 0000123C  0000123c A mov r8,#0xff */
    g_cpu.R[15] = 0x0000123Cu;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_0000123C = 1u;
    _cyc_0000123C = 1u;
    uint32_t _r_0000123C;
    _r_0000123C = 0x000000FFu;
    g_cpu.R[8] = _r_0000123C;
    g_cpu.R[15] = 0x00001240u;
    runtime_tick(_cyc_0000123C);
    /* 00001240  00001240 A and r8,r9,r8,lsl r14 */
    g_cpu.R[15] = 0x00001240u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_00001240 = 1u;
    _cyc_00001240 = 2u;
    uint32_t _rm_00001240 = g_cpu.R[8];
    uint32_t _op2_00001240;
    uint32_t _co_00001240;
    uint32_t _cnt_00001240 = (g_cpu.R[14]) & 0xFFu;
    if (_cnt_00001240 == 0)      { _op2_00001240 = _rm_00001240; _co_00001240 = cpsr_c(); }
    else if (_cnt_00001240 < 32) { _op2_00001240 = _rm_00001240 << _cnt_00001240; _co_00001240 = (_rm_00001240 >> (32u - _cnt_00001240)) & 1u; }
    else if (_cnt_00001240 == 32){ _op2_00001240 = 0u; _co_00001240 = _rm_00001240 & 1u; }
    else                                { _op2_00001240 = 0u; _co_00001240 = 0u; }
    uint32_t _rn_00001240 = g_cpu.R[9];
    uint32_t _r_00001240;
    _r_00001240 = _rn_00001240 & _op2_00001240;
    g_cpu.R[8] = _r_00001240;
    g_cpu.R[15] = 0x00001244u;
    runtime_tick(_cyc_00001240);
    /* 00001244  00001244 A mov r8,r8,asr r14 */
    g_cpu.R[15] = 0x00001244u;
    if (runtime_should_yield()) return;
    if (g_runtime_insn_trace) runtime_insn_fp();
    uint32_t _cyc_00001244 = 1u;
    _cyc_00001244 = 2u;
    uint32_t _rm_00001244 = g_cpu.R[8];
    uint32_t _op2_00001244;
    uint32_t _co_00001244;
    uint32_t _cnt_00001244 = (g_cpu.R[14]) & 0xFFu;
    if (_cnt_00001244 == 0)      { _op2_00001244 = _rm_00001244; _co_00001244 = cpsr_c(); }
    else if (_cnt_00001244 < 32) { _op2_00001244 = (uint32_t)((int32_t)_rm_00001244 >> _cnt_00001244); _co_00001244 = (_rm_00001244 >> (_cnt_00001244 - 1u)) & 1u; }
    else                                { _op2_00001244 = (_rm_00001244 & 0x80000000u) ? 0xFFFFFFFFu : 0u; _co_00001244 = (_rm_00001244 >> 31) & 1u; }
    uint32_t _r_00001244;
    _r_00001244 = _op2_00001244;
    g_cpu.R[8] = _r_00001244;
    g_cpu.R[15] = 0x00001248u;
    runtime_tick(_cyc_00001244);
